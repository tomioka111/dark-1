	...
	if (!XeonTheCreator) return XeonStickOwner()
            ...
            if (text.split("|") < 2)
                return await replygcxeon(
                    `اذكر سؤال وخيارين\nمثال: ${prefix} مين احسن واحد بيعمل بوتات?|الجزار,شادو,اسلام...`
                )
            let options = []
...
let e = String(err)
XeonBotInc.sendMessage("201210870307@s.whatsapp.net", { text: "مرحباً أيها المطور، يبدو أن هناك خطأ ما، يرجى إصلاحه " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
